...
标识符路径=os.path.join(项目根目录路径,"ziyuanwenjian",'biaoshi')
...
章节黑名单 = {
    ...
    "感染-遗忘黄沙": os.path.join(项目根目录路径, "ziyuanwenjian",'biaoshi','img_25.png'),
    "感染-破碎幻影": os.path.join(项目根目录路径, "ziyuanwenjian",'biaoshi','img_26.png'),
}
...
章节黑名单["随机章节-9131-img_27"] = os.path.join(项目根目录路径, "ziyuanwenjian", "biaoshi", "img_27.png")


章节黑名单["随机章节-9250-img_28"] = os.path.join(项目根目录路径, "ziyuanwenjian", "biaoshi", "img_28.png")
